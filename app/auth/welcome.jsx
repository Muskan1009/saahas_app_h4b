...
export default function Welcome() {
  ...
  return (
    <KeyboardAvoidingView
      className="flex-1 bg-white py-20"
      behavior={Platform.OS === 'ios' ? 'padding' : undefined}
    >
      {/* Heading and Description */}
      <View className="items-center mb-8 px-8">
        <Text className="text-2xl font-semibold text-black text-center">Welcome to Saahas</Text>
        <Text className="text-center text-gray-500 mt-3 leading-relaxed text-sm mb-10">
      ...
      <View className="px-8">
        <TouchableOpacity
          onPress={() => router.push('/auth/adhaar')}
          className="bg-[#6757DB] py-3 rounded-3xl px-8"
        >
          <Text className="text-white text-center font-medium text-base">Let’s begin with KYC</Text>
        </TouchableOpacity>
      </View>
    </KeyboardAvoidingView>
  );
